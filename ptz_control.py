...
IP = "192.1.1.163"  # Camera IP address
PORT = 80  # Port
USER = "admin"  # Username
PASS = "123asdASD"  # Password
...
class ptzControl(object):
    ...
    def movePTZ(self, tilt, pan, zoom, vel):
        self.requestr.Translation.PanTilt.x = tilt
        self.requestr.Translation.PanTilt.y = pan
        self.requestr.Translation.Zoom.x = zoom
        self.requestr.Speed.PanTilt.x = vel
        self.requestr.Speed.PanTilt.y = vel
        self.requestr.Speed.Zoom.x = vel
        ret = self.ptz.RelativeMove(self.requestr)

    def only_zoom(self, zoom, vel=0.5):
        self.requestr.Translation.PanTilt.x = 0.
        self.requestr.Translation.PanTilt.y = 0.
        self.requestr.Translation.Zoom.x = zoom
        self.requestr.Speed.PanTilt.x = 0.
    ...
    def move_tw(self, velocity_pan, velocity_tilt):
        self.requestc.Velocity.PanTilt.x = velocity_pan
        self.requestc.Velocity.PanTilt.y = velocity_tilt
        self.requestc.Velocity.Zoom.x = 0.0
        self.perform_move(self.requestc)